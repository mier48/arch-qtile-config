...
primary_widgets = [
    *workspaces(),
    ...
    icon(fg='ffffff', bg="dark", text=' '), # Icon: nf-fa-download
    ...
    widget.Battery(**base(bg='color4'), format='{percent:2.0%}', padding=5),
...
#    powerline('color3', 'color4'),
    ...
    widget.Memory(**base(bg='color2'), padding=5, measure_mem='G'),
